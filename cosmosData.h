...
const std::string VERSION = "4.7.1.0b";
const std::string REPLAYCODE = "471b"; //4-number/letter sequence at the start of replay, that helps identify calc version. First 4 characters are responsible for tournament info in replay.
